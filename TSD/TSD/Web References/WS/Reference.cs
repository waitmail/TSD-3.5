...
namespace TSD.WS {
    ...
    public partial class WS : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/Upload_logs", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public string Upload_logs(string guid, string data, int num_base) {
            object[] results = this.Invoke("Upload_logs", new object[] {
                        guid,
                        data,
                        num_base});
            return ((string)(results[0]));
        ...
        /// <remarks/>
        public System.IAsyncResult BeginUpload_logs(string guid, string data, int num_base, System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("Upload_logs", new object[] {
                        guid,
                        data,
                        num_base}, callback, asyncState);
        }
        ...
        /// <remarks/>
        public string EndUpload_logs(System.IAsyncResult asyncResult) {
            object[] results = this.EndInvoke(asyncResult);
            return ((string)(results[0]));
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/GetStarterTSD", RequestNamespace="http://tempuri.org/", ResponseNamespace="http://tempuri.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        [return: System.Xml.Serialization.XmlElementAttribute(DataType="base64Binary")]
        public byte[] GetStarterTSD(string guid, string data, int num_base) {
            object[] results = this.Invoke("GetStarterTSD", new object[] {
                        guid,
                        data,
                        num_base});
            return ((byte[])(results[0]));
        ...
        /// <remarks/>
        public System.IAsyncResult BeginGetStarterTSD(string guid, string data, int num_base, System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("GetStarterTSD", new object[] {
                        guid,
                        data,
                        num_base}, callback, asyncState);
        }
